...
namespace Allure.Examples.NUnit3.WebUITests
{
    ...
    class LabelTests : WebUITestFixtureBase
    {
        ...
        [Test]
        [AllureName("Create new label by authorized user")]
        [AllureTag("regress")]
        ...
        [Test]
        [AllureName("Add label to existing issue by authorized user")]
        [AllureTag("smoke")]
        ...
        [Test]
        [AllureName("Delete existing label by authorized user")]
        [AllureTag("smoke")]
